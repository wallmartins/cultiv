...
function parseArgs(argv) {
  ...
  const outPath = argv.includes("--out") ? resolve(argv[argv.indexOf("--out") + 1] ?? "calibration-sweep-manifest.json") : resolve(repoRoot, "docs/superpowers/reports/calibration-sweep-manifest.json");
