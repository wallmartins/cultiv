...
export const googleFontsAsyncScript = `(function(){var href=${JSON.stringify(GOOGLE_FONTS_STYLESHEET)};var link=document.createElement("link");link.rel="stylesheet";link.href=href;document.head.appendChild(link);})();`;
...
export function brandHeadLinks() {
  return [
    ...
    { rel: "preload", href: GOOGLE_FONTS_STYLESHEET, as: "style" },
