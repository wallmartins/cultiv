...
export const appMessagesEn: AppMessages = {
  ...
  voice: {
    ...
    quantitativeDashboard: {
      ...
      subtitle: "Measures from the calibration wizard — diagnostic, not a score.",
      consistency: "Consistency",
      topicIndependence: "Topic independence",
      crossLength: "Cross-length consistency",
      perStepTitle: "Per-step variance",
      varianceLabel: "Cadence variance per wizard step",
      scoreGood: "good",
      scoreFair: "fair",
      scoreLow: "low",
      highestVarianceHint: "This step has the highest variance — it may mean a different context or unfamiliar topic.",
      redoStep: "Redo step",
      bonusTopicTitle: "Topic independence",
      bonusTopicBody: "An extra text on another topic can strengthen your profile. Optional and does not use quota.",
      bonusTopicAction: "Write extra text",
      keepAsIs: "Keep as is"
    }
  },
  onboarding: {
    stepLabel: "Step {current} of {total}",
    step1Title: "Calibrate your voice",
    step1Subtitle: "Five short personalized texts reveal how you think and write.",
    ...
    voiceCalibration: {
      ...
      preSubtitle: "Three quick questions to personalize wizard themes.",
      wizardTitle: "Voice calibration",
      wizardSubtitle: "Write as you naturally would — without over-editing.",
      domainQuestion: "What area do you work or write in?",
      audienceQuestion: "Who do you usually write for?",
      strengthQuestion: "Anything you do well as a writer? (optional)",
      strengthPlaceholder: "E.g. I'm direct, I use analogies, I like opening with a question…",
      stepIndicator: "Step {current} of {total}",
      wordCount: "{current} / {target} words (min. {min})",
      wordCountMin: "Write at least {min} words to continue",
      skipStep: "Skip step",
      skipPenalty: "Skipping lowers profile confidence — only if you can't write now.",
      back: "Back",
      submitting: "Saving…",
      reviewThinking: "How you think",
      reviewDevelopment: "How you develop texts",
      reviewConsistency: "Voice consistency",
      ...
      topicIndependenceScore: "Topic independence: {score}",
      domainOptions: {
      ...
      audienceOptions: {
        colegas: "Peers",
        clientes: "Clients",
        publico_geral: "General public",
        comunidade_tecnica: "Technical community",
        estudantes: "Students"
      },
      stepLabels: {
        micro_opinion: "Short opinion",
        reasoning_reflection: "How I think",
        argument_development: "How I build",
