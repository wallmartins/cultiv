...
export const appMessagesPt: AppMessages = {
  ...
  voice: {
    ...
    quantitativeDashboard: {
      title: "Sinais quantitativos",
      subtitle: "Medidas extraídas do wizard de calibração — diagnóstico, não nota.",
      consistency: "Consistência",
      topicIndependence: "Independência de tema",
      crossLength: "Consistência entre tamanhos",
      perStepTitle: "Variância por etapa",
      varianceLabel: "Variância de cadência por etapa do wizard",
      scoreGood: "boa",
      scoreFair: "razoável",
      scoreLow: "baixa",
      highestVarianceHint: "Esta etapa tem a maior variância — pode indicar contexto diferente ou tema pouco familiar.",
      redoStep: "Refazer etapa",
      bonusTopicTitle: "Independência de tema",
      bonusTopicBody: "Um texto extra em outro tema pode fortalecer o perfil. Opcional e não consome quota.",
      bonusTopicAction: "Escrever texto extra",
      keepAsIs: "Manter assim"
    }
  },
  onboarding: {
    stepLabel: "Passo {current} de {total}",
    step1Title: "Calibre sua voz",
    step1Subtitle: "Cinco textos curtos personalizados revelam como você pensa e escreve.",
    ...
    voiceCalibration: {
      preTitle: "Antes de começar",
      preSubtitle: "Três perguntas rápidas para personalizar os temas do wizard.",
      wizardTitle: "Calibração de voz",
      wizardSubtitle: "Escreva como você escreveria naturalmente — sem editar demais.",
      domainQuestion: "Em que área você atua ou escreve?",
      audienceQuestion: "Para quem você normalmente escreve?",
      strengthQuestion: "Tem algo que você faz bem como escritor? (opcional)",
      strengthPlaceholder: "Ex.: sou direto, uso analogias, gosto de abrir com pergunta…",
      stepIndicator: "Etapa {current} de {total}",
      wordCount: "{current} / {target} palavras (mín. {min})",
      wordCountMin: "Escreva pelo menos {min} palavras para continuar",
      skipStep: "Pular etapa",
      skipPenalty: "Pular reduz a confiança do perfil — use só se não conseguir escrever agora.",
      back: "Voltar",
      submitting: "Salvando…",
      reviewThinking: "Como você pensa",
      reviewDevelopment: "Como você desenvolve textos",
      reviewConsistency: "Consistência da sua voz",
      ...
      topicIndependenceScore: "Independência de tema: {score}",
      domainOptions: {
      ...
      audienceOptions: {
        ...
        comunidade_tecnica: "Comunidade técnica",
