import { SHOWCASE_CONTENT_PREVIEW_BLOCK_COUNT } from "~/marketing/content/showcase/format-thread";
import { resolveDocumentForPreview } from "~/marketing/content/showcase/format-prose-document";
import type { ShowcasePostDocument, ShowcaseSample } from "~/marketing/content/showcase/types";
