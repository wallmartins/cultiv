    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="rounded-[var(--radius-cartography)] bg-pigment-terracotta/10 px-3 py-2 text-sm font-medium text-ink underline-offset-2 hover:underline"
        >
...
function TraitStripCell({
  ...
  return (
    <div className="rounded-[var(--radius-cartography)] border border-ink-ghost/60 bg-paper-elevated/40 px-3 py-3">
