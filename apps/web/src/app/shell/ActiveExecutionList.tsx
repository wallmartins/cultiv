        ...
        <ul className="space-y-2 overflow-y-auto">
          {items.map((item) => (
            <li key={item.id}>
              <button
                type="button"
                className="w-full rounded-[var(--radius-cartography)] border border-ink-ghost bg-paper-elevated px-3 py-2 text-left transition-colors hover:bg-paper-pressed"
