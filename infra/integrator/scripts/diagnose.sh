...
echo "=== Recent Errors ==="
tail -n 20 /home/ubuntu/cultiv/logs/api-err.log 2>/dev/null || echo "No error logs"
tail -n 20 /home/ubuntu/cultiv/logs/worker-err.log 2>/dev/null || echo "No worker error logs"
echo ""

echo "=== Health Check Log ==="
tail -n 5 /home/ubuntu/cultiv/logs/health-check.log 2>/dev/null || echo "No health check logs"
echo ""

echo "=== Metrics ==="
cat /home/ubuntu/cultiv/metrics/current.json 2>/dev/null || echo "No metrics available"
echo ""
