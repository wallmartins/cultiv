...
Product Requirements Documents for active Cultiv work.

| PRD | Status | Implementation plan |
|-----|--------|---------------------|
...
|-------|--------|------------|
| [Product Showcase Restructure](./issue-product-showcase-restructure.md) | `ready-for-agent` | [Phase 1.2 PRD](./cultiv-product-showcase-restructure.md) |

## Issues (Authenticated Workspace — Web v2)

| Issue | Status | Parent PRD |
|-------|--------|------------|
| [Authenticated Workspace Web v2](./issue-authenticated-workspace-web-v2.md) | `ready-for-agent` | [Web v2 PRD](./cultiv-authenticated-workspace-web-v2.md) |

Child slices: [`27`–`34`](../issues/README.md#authenticated-workspace--web-v2) in `docs/live/issues/`.

## Issues (Workspace Visual Refresh)

| Issue | Status | Parent PRD |
|-------|--------|------------|
| [Workspace Visual Refresh](./issue-workspace-visual-refresh.md) | `ready-for-agent` | [Workspace Visual Refresh PRD](./workspace-visual-refresh.md) |

Child slices: [`39`–`47`](../issues/README.md#workspace-visual-refresh) in `docs/live/issues/`.

## Issues (Durable Async Runtime)

| Issue | Status | Parent PRD |
|-------|--------|------------|
| [Durable Async Runtime](./issue-durable-async-runtime.md) | `ready-for-agent` | [Durable Async Runtime PRD](./durable-async-runtime.md) |

Child slices: [`48`–`57`](../issues/README.md#durable-async-runtime) in `docs/live/issues/`.

## Issues (Text Generation)
