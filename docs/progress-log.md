...
| 2026-06-18 | refactor(web): Fase 4 — split `GenerationScreen.tsx` (657→349 lines) into `useGenerationForm`, `useGenerationCommercialGate`, `get-blocked-reason`, `GenerationPreviewSidebar`, `BriefingGuidancePanel`; `tests/web/use-generation-commercial-gate.test.ts` (8 tests); no UX change |
